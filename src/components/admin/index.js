...
const MY_POLICIES = [
     {id:'1',registeredOn:'28-09-2022',status:'active',claimStatus:'',name: 'Bajaj Allianz General Insurance Co.'}
    ,{id:'2',registeredOn:'28-09-2022',status:'active',claimStatus:'',name: 'Bharti AXA General Insurance Co.'}
...
export const Admin = (props) => {
  ...
  const [viewDocs, setViewDocsOpen] = React.useState(false);

  const handleViewDocs = () => {
    setViewDocsOpen(!viewDocs);
  }
...
<div className='table-container'>
  <div className='heading'>Claim requests</div>
        ...
        <TableBody>
          {rows.map((row) => (
            <StyledTableRow key={row.id}>
              ...
              <StyledTableCell align="left"> <Button variant="outlined" onClick={handleViewDocs}>View</Button></StyledTableCell>
              <StyledTableCell align="left"><Button variant="outlined">Approve</Button></StyledTableCell>
              <StyledTableCell align="left"><Button variant="outlined">Reject</Button></StyledTableCell>
            </StyledTableRow>
          ))}
        </TableBody>
      </Table>
    </TableContainer>
    {viewDocs && <ViewDocs viewDocs ={viewDocs} setViewDocsOpen={setViewDocsOpen}/>}
    </div>
    </div>
  );
}
