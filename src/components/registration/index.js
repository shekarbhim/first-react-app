...
const Registration = (props) => {
  ...
  return (
    <div className="registration-container">
      <Grid container rowSpacing={2} columnSpacing={{ xs: 1, sm: 2, md: 3, lg: 1 }} style={{marginTop: '30px'}}>
  ...
  <Grid item lg={11} md={12}  style={{ paddingLeft: '30px', height: '100px'}}>
  ...
  <div className="policy">
      <FormControl sx={{ m: 1, width: 300 }}>
        ...
        <Select
          ...
          input={<OutlinedInput id="select-multiple-chip" label="Policy" />}
